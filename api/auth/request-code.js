...
export default async function handler(req, res) {
  ...
  // NOTE: the @wpi.edu-only restriction is temporarily lifted here too, so
  // testing with a personal email works while a sending domain gets
  // verified with Resend. Re-add the .endsWith('@wpi.edu') check above
  // before opening this up to other WPI students.
